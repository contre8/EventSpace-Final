 ...
 */
package com.mycompany.eventspace.rest;
...
@Named
@Stateless
@Path("com.mycompany.eventspace.entities.reservarespacio")
public class ReservarEspacioFacadeREST extends AbstractFacade<ReservarEspacio> {

    @PersistenceContext(unitName = "com.mycompany_eventSpace_war_1.0-SNAPSHOTPU")
    ...
    private ReservarEspacioPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.mycompany.eventspace.entities.ReservarEspacioPK key = new com.mycompany.eventspace.entities.ReservarEspacioPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.mycompany.eventspace.entities.ReservarEspacioPK key = getPrimaryKey(id);
