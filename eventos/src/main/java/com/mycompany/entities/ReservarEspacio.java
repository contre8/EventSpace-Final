...
public class ReservarEspacio implements Serializable {
    ...
    @JoinColumn(name = "cliente", referencedColumnName = "dni", insertable = false, updatable = false)
    ...
    public String toString() {
        return "com.mycompany.entities.ReservarEspacio[ reservarEspacioPK=" + reservarEspacioPK + " ]";
    }
